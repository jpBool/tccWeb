    ...
    <div class="globo">                             
        ...
        <div class="textos">
            <div class="divbonita">
                ...
                <div class="textprimeiro">
                    <img src="{{'assets/img_tcc/icon2.svg'}}" alt="img" class="sidebar-icon-overlay" style="width: 2%;" >
    
                    <div class="imgtextos">
                        <img src="{{'assets/img_tcc/img1.jpg'}}" alt="img" class="imgtexto1" style="width: 70%;" > 
                    </div>
                </div>
        ...
        <div class="textoimagem">
            ...
            <div class="imgtextos">
                <img src="{{'assets/img_tcc/img2.jpg'}}" alt="img" class="imgtexto1" style="width: 70%;" > 
            </div>
        </div>

        <img src="{{'assets/img_tcc/icon3.svg'}}" alt="img" class="icon3" style="width: 2%;" > 
        ...
        <div class="textoimagem">
            ...
            <div class="imgtextos">
                <img src="{{'assets/img_tcc/img3.jpg'}}" alt="img" class="imgtexto1" style="width: 70%;" > 
            </div>
        </div>
            </div>

        <img src="{{'assets/img_tcc/icon4.svg'}}" alt="img" class="icon4" style="width: 2%;" > 
        ...
        <div class="imgtextos">
            <img src="{{'assets/img_tcc/img4.jpg'}}" alt="img" class="imgtexto1" style="width: 70%;" > 
        </div>
</div>
</div>
